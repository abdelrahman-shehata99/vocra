...
void main() {
  group('SpeechTextNormalizer', () {
    ...
    test('strips bold, italic, and inline code markers but keeps their text',
        () {
      expect(
    ...
    test('returns empty for a sentence that is only emoji, an image, or a tag',
        () {
